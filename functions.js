...
function mostrarCaja(textoClave, cajon1, cajon2){   
    ...
    cajon2.style.animation = "fade-in-bottom 1s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.5s both";
...
function ocultarCaja(palabras, parte1, parte2){
    ...
    parte1.style.animation = "fade-in-bottom 1s cubic-bezier(0.390, 0.575, 0.565, 1.000) 0.5s both";
